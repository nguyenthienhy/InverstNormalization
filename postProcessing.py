...
text = combineNumber("1 tôi cần số điện thoại 0 9 8 7 1 2 3 4 1 3 2 với số tiền 1 3 5 7 8 hiện tại tôi đang cần kiểm tra một số điện thoại 0 9 8 3 1 2 2 3")
print(text)